...
* [Spring Reactive Web](https://docs.spring.io/spring-boot/docs/3.2.0-RC1/reference/htmlsingle/index.html#web.reactive)
* [Rest Repositories](https://docs.spring.io/spring-boot/docs/3.2.0-RC1/reference/htmlsingle/index.html#howto.data-access.exposing-spring-data-repositories-as-rest)
...
* [Building REST com.services with Spring](https://spring.io/guides/tutorials/rest/)
